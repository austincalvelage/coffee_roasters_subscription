  ...
  return (
    <section>
      <Grid classes='relative space-y-2 md:space-y-0'>
        <h2 className='[#333D4B]/5 col-span-full col-start-1 bg-gradient-to-b from-[#83888F]/50 to-white bg-clip-text text-center font-fraunces text-[40px] font-bold text-transparent md:from-[#83888F]/30 md:text-[96px] '>
          our collection
        </h2>

        <div className='relative col-span-full col-start-1 flex flex-col space-y-3 md:-top-9 md:flex-row md:justify-center xl:col-span-3 xl:flex-col xl:items-center xl:space-y-9'>
