export default function OurHeadquarters() {
  ...
  return (
    <div className='space-y-10 xl:px-11'>
      ...
      <div className='space-y-10 md:flex md:gap-10 md:space-y-0 xl:gap-20'>
        {headquarters.map((hq, index) => (
          <div className='flex flex-col items-center text-center md:items-start md:text-left' key={index}>
            {hq.image()}
            <h2 className='mt-6 mb-3 font-fraunces text-[28px] font-black leading-9 text-dark-grey-blue md:text-lg xl:text-xl'>
              {hq.country}
            </h2>
            <p className='font-barlow leading-7 text-dark-grey-blue'>
              {hq.address}
              <br />
              {hq.city}
              <br />
