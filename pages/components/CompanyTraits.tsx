...
function CompanyTraits(): JSX.Element {
  ...
  return (
    <section className="rounded-sm bg-[#2C343E] h-[900px] md:h-[578px] md:pt-5 xl:pt-12">
      <Grid classes="text-[#FEFCF7] text-center pt-6 pb-10 md:pb-0">
        <h2 className="col-span-full col-start-1 font-fraunces text-3xl xl:text-[40px] font-bold">
          Why choose us?
        </h2>
        <p className=" col-start-2 col-span-6 font-barlow text-[15px] md:col-span-12 md:col-start-3 xl:col-span-8 xl:col-start-5">
      ...
      <Grid classes="relative md:top-8 xl:top-12 space-y-2 xl:space-y-0">
        <Grid classes="py-5 rounded-sm bg-[#0E8784] col-span-6 col-start-2 md:col-span-14 md:col-start-2 md:flex-row md:py-4 xl:col-span-4 xl:col-start-3">
          <div className="col-span-full col-start-1 place-self-center md:col-span-2 w-9 md:col-start-3 xl:col-span-full xl:col-start-1 xl:place-self-center">
            <Image
              src={traits[0].image}
              alt="coffee beans"
              layout="responsive"
          ...
          <div className="col-span-6 col-start-2 place-self-center text-center md:col-span-9 md:col-start-6 space-y-3 text-[#FEFCF7] md:text-left xl:col-span-14 xl:col-start-2 xl:place-self-center xl:text-center">
